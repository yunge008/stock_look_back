...
const initial = {
  ...
  max_strategy_cash: 200000, base_cash: 30000, quality_confirmed: true, lookback_days: 360,
  entry_drawdown_pct: 0.30, ma_discount_pct: 0.15, entry_condition_mode: 'all',
  grid_drop_pcts: [0.05, 0.10, 0.15, 0.20], grid_cash_multipliers: [1, 2, 2, 3],
  lot_take_profit_pct: 0.10, basket_take_profit_enabled: false, basket_take_profit_pct: 0.10,
  reentry_drop_pct: 0, commission_rate: 0.0005, min_commission: 5,
