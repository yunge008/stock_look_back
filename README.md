...
1. 输入 A 股、ETF 或美股代码，例如 `603728`、`600519`、`513500`、`AAPL`、`BRK.B`、`0700.HK`、`9988.HK`。
...
- 美股：Yahoo Finance 日线，使用自动复权 OHLC（包括拆股与分红调整）。`r`n- 港股：Yahoo Finance 日线，代码须带 `.HK` 后缀（如 `0700.HK`）；使用自动复权 OHLC。港股整手数因标的而异，当前回测按 1 股最小单位模拟。
